...
#ifndef _MDMIDIFILE_PROGMEM_H
#define _MDMIDIFILE_PROGMEM_H
...
protected:
  ...
  byte     *_sd;               ///< SDFat library descriptor supplied by calling program
  byte    *_fd;                ///< SDFat file descriptor
